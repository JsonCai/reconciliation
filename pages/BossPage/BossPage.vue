<template>
	<view>
		...
		<mescroll-body ref="mescrollRef" @init="mescrollInit" top="100" :down="downOption" @down="downCallback" @up="upCallback">
			<!-- 新增的微博 -->
...
<script>
	...
	import switchTab from "@/components/swiperTab/swiperTab.vue"
